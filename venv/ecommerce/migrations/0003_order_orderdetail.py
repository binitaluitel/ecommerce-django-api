    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_numbere', models.CharField(max_length=15)),
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('Delivered', 'Delivered'), ('Cancelled', 'Cancelled')], default='Pending', max_length=225)),
